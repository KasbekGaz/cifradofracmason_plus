# Definir las cuadrículas y la cruz del cifrado francmasón
cuadricula1 = [
    ['j', 'B', 'C'],
    ['D', 'L', 'R'],
    ['G', 'H', 'P']
...
# Mostrar las secciones después de rotar e intercambiar


def mostrar_secciones(secciones):
...
# Mostrar las secciones después de cifrado
print("\nPosiciones de las letras después de cifrar:")
mostrar_secciones(secciones_intercambiadas)
